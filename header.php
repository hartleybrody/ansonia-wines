        ...
        <div id="header" class="row clearfix visible-desktop">
            ...
            <div class="span6">
                ...
                <div id="mc_embed_signup">
                    <form action="//ansoniawines.us10.list-manage.com/subscribe/post?u=ecdc119b3e0f9307376bd0bb7&amp;id=c9624d5296" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                        <div id="mc_embed_signup_scroll">
                            ...
                            <div class="mc-field-group">
                                <label for="mce-MMERGE3">Home State </label>
                            ...
                            <div style="position: absolute; left: -5000px;"><input type="text" name="b_ecdc119b3e0f9307376bd0bb7_c9624d5296" tabindex="-1" value=""></div>
